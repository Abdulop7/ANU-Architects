                ...
                >
                    ...
                    >
                        ...
                        <div className="flex xl:justify-end items-start pointer-events-auto w-full mt-4 md:mt-0">
                            <a href="/projects" className="relative overflow-hidden inline-flex items-center justify-center gap-6 border border-white/30 text-white px-8 lg:px-10 py-4 lg:py-5 rounded-full font-bold uppercase tracking-[0.15em] transition-colors duration-500 group w-full md:w-auto">
