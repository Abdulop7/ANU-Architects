            ...
            <div className="flex flex-col h-full justify-center">
              ...
              <div className="flex flex-col gap-4 w-full sm:max-w-md">
                ...
                <Link
                  ...
                  target="_blank"
                  className="group relative inline-flex items-center justify-between w-full bg-[#1877F2] rounded-full p-2 pr-8 transition-all duration-500 hover:shadow-[0_0_60px_rgba(24,119,242,0.6)] hover:-translate-y-1 overflow-hidden"
                >
                ...
                {/* Instagram Button */}
                <Link
                  href="https://www.instagram.com/consultanuarchitect/?hl=en"
                  target="_blank"
                  className="group relative inline-flex items-center justify-between w-full bg-gradient-to-tr from-[#FFDC80] via-[#F56040] to-[#C13584] rounded-full p-2 pr-8 transition-all duration-500 hover:shadow-[0_0_60px_rgba(193,53,132,0.6)] hover:-translate-y-1 overflow-hidden"
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent -translate-x-[150%] group-hover:translate-x-[150%] transition-transform duration-1000 ease-in-out"></div>
                  <div className="relative z-10 w-16 h-16 bg-white text-[#C13584] rounded-full flex items-center justify-center shadow-lg group-hover:scale-105 transition-transform duration-300">
                  ...
                  <span className="relative z-10 font-sans font-black text-[1.1rem] uppercase tracking-[0.15em] text-white ml-6 drop-shadow-md">Follow on Insta</span>
                  <div className="relative z-10 flex-1 flex justify-end">
                    <svg className="w-6 h-6 text-white group-hover:translate-x-2 transition-transform drop-shadow-md" fill="none" stroke="currentColor" strokeWidth="3" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M5 12h14M12 5l7 7-7 7"></path>
                    </svg>
                  </div>
                </Link>
